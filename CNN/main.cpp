...
/*
void test_minst(){
	LabelArr testLabel=read_Lable("C:\Users\cuteandbeautifulhong\Desktop\DeepLearningC-master\DeepLearningC-master\CNN\Minst\test-labels.idx1-ubyte");
	ImgArr testImg=read_Img("C:\Users\cuteandbeautifulhong\Desktop\DeepLearningC-master\DeepLearningC-master\CNN\Minst\test-images.idx3-ubyte");
...
int main()
{
	LabelArr trainLabel=read_Lable("C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\train-labels.idx1-ubyte");
	ImgArr trainImg=read_Img("C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\train-images.idx3-ubyte");
	LabelArr testLabel=read_Lable("C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\t10k-labels.idx1-ubyte");
	ImgArr testImg=read_Img("C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\t10k-images.idx3-ubyte");
	...
	//savecnn(cnn,"C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\CNNData.txt");
	
	FILE  *fp=NULL;
	fp=fopen("C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\CNNL.txt","wb");
	if(fp==NULL)
		printf("write file failed\n");
	fwrite(cnn->L,sizeof(float),trainNum,fp);
	fclose(fp);
	
	importcnn(cnn,"C:\\Users\\cuteandbeautifulhong\\Desktop\\DeepLearningC-master\\DeepLearningC-master\\CNN\\Minst\\cnn.txt");
	int testNum=10000;
	float incorrectRatio=0.0;
	incorrectRatio=cnntest(cnn,testImg,testLabel,testNum);
	printf("test finished!!\n");
	printf("%f",incorrectRatio);
